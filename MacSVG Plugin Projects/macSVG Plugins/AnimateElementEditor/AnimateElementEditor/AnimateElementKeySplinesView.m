...
@implementation AnimateElementKeySplinesView
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    for (NSInteger i = 0; i < (keyValuesArrayCount - 1); i++)
    {
        ...
        //float startTime = [startTimeString floatValue];
        //float endTime = [endTimeString floatValue];
        
        //float startX = startTime * 100;
        //float endX = endTime * 100;
