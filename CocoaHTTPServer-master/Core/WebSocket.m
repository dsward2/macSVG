...
+ (BOOL)isWebSocketRequest:(HTTPMessage *)request
{
	...
	//else if (![upgradeHeaderValue caseInsensitiveCompare:@"WebSocket"] == NSOrderedSame) {    // dsward this line replaced
	else if (!([upgradeHeaderValue caseInsensitiveCompare:@"WebSocket"] == NSOrderedSame)) {    // dsward added parentheses
		isWebSocket = NO;
	}
